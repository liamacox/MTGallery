...
var packGeneratorFactory = new PackGeneratorFactory(postgreSqlRepository);
var packGenerator = new PackGenerationCoordinator(packGeneratorFactory, configuredSetsOptions);
